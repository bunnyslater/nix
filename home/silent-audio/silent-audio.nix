    ...
    ".local/share/silent-audio/silent-audio.sh" = {
      text = ''
        ...
        while true; do
          ...
          ${pkgs.bash}/bin/bash -c "sleep 1; ${pkgs.alsa-utils}/bin/aplay /home/billie/.local/share/silent-audio/silent.wav" &
          ${pkgs.alsa-utils}/bin/aplay /home/billie/.local/share/silent-audio/silent.wav
        done
      '';
      executable = true;
    };
